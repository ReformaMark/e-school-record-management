...
export const transmutationTable3 = [
    ...
    { "min": 95.21, "max": 96.79, "transmutedGrade": 97 },
    ...
    { "min": 69.61, "max": 71.19, "transmutedGrade": 81 },
    { "min": 68.00, "max": 69.59, "transmutedGrade": 80 },
    { "min": 66.40, "max": 67.98, "transmutedGrade": 79 },
    { "min": 64.81, "max": 66.39, "transmutedGrade": 78 },
    { "min": 63.21, "max": 64.79, "transmutedGrade": 77 },
    { "min": 61.60, "max": 63.19, "transmutedGrade": 76 },
    { "min": 60.01, "max": 61.59, "transmutedGrade": 75 },
    { "min": 56.00, "max": 59.99, "transmutedGrade": 74 },
    { "min": 52.01, "max": 55.99, "transmutedGrade": 73 },
    { "min": 48.00, "max": 51.99, "transmutedGrade": 72 },
    { "min": 44.00, "max": 47.99, "transmutedGrade": 71 },
    { "min": 40.01, "max": 43.99, "transmutedGrade": 70 },
...
export const transmutationTableSHSCore2 = [
        ...
        { "min": 42.01, "max": 44.99, "transmutedGrade": 74 },
        { "min": 39.02, "max": 42.00, "transmutedGrade": 73 },
        { "min": 36.03, "max": 39.01, "transmutedGrade": 72 },
...
export const transmutationTableSHS2 = [
    ...
    { "min": 34.01, "max": 36.83, "transmutedGrade": 72 },
